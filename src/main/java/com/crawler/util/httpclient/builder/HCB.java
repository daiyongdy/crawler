package com.crawler.util.httpclient.builder;

import com.crawler.util.httpclient.common.SSLs;
...
//		return (HCB) this.setConnectionManager(connManager);
	...
	public HCB creds(String proxyUser, String proxyPass) {
		CredentialsProvider credsProvider = new BasicCredentialsProvider();
		credsProvider .setCredentials(AuthScope.ANY, new UsernamePasswordCredentials(proxyUser, proxyPass));
		return (HCB) this.setDefaultCredentialsProvider(credsProvider);
	}
