...
import com.crawler.util.httpclient.common.HttpMethods;
import com.crawler.util.httpclient.common.Utils;
...
public class HttpClientUtil {
	 ...
	 * @return
	 */
	public static String getTargetHost(HttpConfig config) throws HttpProcessException {
	...
	private static HttpResponse execute(HttpConfig config) throws HttpProcessException {
		...
		try {
			//创建请求对象
			request = getRequest(config.url(), config.method());
